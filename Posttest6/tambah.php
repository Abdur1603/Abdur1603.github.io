...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (!empty($nama) && !empty($no_hp) && !empty($payment) && !empty($foto)) {
        header("Location: detail.php?durasi=$durasi&harga=$harga&nama=$nama&no_hp=$no_hp&payment=$payment&foto=$foto");
        exit();
    } else {
