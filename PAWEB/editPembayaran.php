...
$result = mysqli_query($koneksi, "SELECT * FROM data_plgn WHERE id_bayar = $id");
...
if (isset($_POST['ubah'])) {
    ...
    if ($file_name) {
        if ($file_size > $max_size) {
            ...
            $sql = "UPDATE data_plgn SET nama='$nama', bukti_pembayaran='$newFileName' WHERE id_bayar =$id";
        }
    } else {
        $sql = "UPDATE data_plgn SET nama='$nama' WHERE id_bayar=$id";
    }
