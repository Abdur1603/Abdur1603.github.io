    ...
    <div class="membership-items">
      <div class="membership-item">
        ...
        <?php if(isset($_SESSION['login']) && $_SESSION['login'] === true): ?>
          <button class="btn">
            <a href="tambah.php?durasi=<?=$membership1['durasi']?>&harga=<?=$membership1['harga']?>&gambar=<?=$membership1['gambar']?>" class="order">Pesan Sekarang</a>
          </button>
        <?php else: ?>
      ...
      <div class="membership-item">
        ...
        <?php if(isset($_SESSION['login']) && $_SESSION['login'] === true): ?>
          <button class="btn">
            <a href="tambah.php?durasi=<?=$membership2['durasi']?>&harga=<?=$membership2['harga']?>&gambar=<?=$membership2['gambar']?>" class="order">Pesan Sekarang</a>
          </button>
        <?php else: ?>
          <p>Silakan <a href="login.php">login</a> untuk memesan paket ini.</p>
        <?php endif; ?>
      ...
      <div class="membership-item">
        ...
        <?php if(isset($_SESSION['login']) && $_SESSION['login'] === true): ?>
          <button class="btn">
            <a href="tambah.php?durasi=<?=$membership3['durasi']?>&harga=<?=$membership3['harga']?>&gambar=<?=$membership3['gambar']?>" class="order">Pesan Sekarang</a>
          </button>
        <?php else: ?>
          <p>Silakan <a href="login.php">login</a> untuk memesan paket ini.</p>
        <?php endif; ?>
...
<div id="about" class="about-container">
  ...
  <div class="about-text">
    ...
    <p>Saya adalah seorang mahasiswa di Universitas Mulawarman yang sedang menempuh pendidikan di jurusan Teknik Informatika. Website ini adalah website yang berhubungan dengan gym. Website ini berisi tentang kelas-kelas gym yang bisa diikuti, membership yang bisa dipilih, dan tentang saya.</p>
  </div>
</div>
<?php
